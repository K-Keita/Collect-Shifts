...
const SignIn = () => {
  ...
  return (
    <div className="main-container">
      ...
      <PrimaryButton fullWidth={true} label="アカウント登録" width={"50%"} onClick={() => dispatch(push("/signup"))} />
      <div className="small-space" />
      <PrimaryButton fullWidth={true} label={"パスワードを忘れた方"} width={"50%"} onClick={() => dispatch(push("/reset"))} />
    </div>
  )
}
