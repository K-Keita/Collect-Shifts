...
const ChangeGroupName = React.memo(() => {
  ...
  return (
    ...
    <TextInput id="manage-password" label={"管理者パスワード"} type={"password"} value={password} onChange={inputPassword} />
    <TextInput id="new-group" label={"新しいグループ名"} type={"text"} value={newGroupName} onChange={inputNewGroupName} />
    </div>
